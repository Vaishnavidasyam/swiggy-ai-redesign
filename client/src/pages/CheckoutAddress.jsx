...
export default function CheckoutAddress() {
  ...
  return (
    <div
      className={`min-h-screen pb-[210px] md:pb-[170px] transition-all duration-300 ${
    ...
    >
      ...
      <div className="w-full max-w-[1500px] mx-auto px-4 md:px-6 xl:px-10">
        ...
        <div className="grid xl:grid-cols-[1fr_0.8fr] gap-6 mt-8">
          {/* LEFT */}
            ...
            >
              ...
              <div className="p-6 border-b border-white/5">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="h-16 w-16 rounded-2xl bg-gradient-to-r from-orange-500 to-pink-500 text-white flex items-center justify-center shadow-md">
                      <MapPin size={26} />
                    </div>
              ...
              <div className="p-6 space-y-5">
                ...
                <motion.button
                  ...
                  className={`w-full rounded-[28px] p-5 flex items-center justify-between transition-all ${
                    darkMode
                      ? "bg-[#1b2435]"
                      : "bg-[#f5f7fb]"
                  }`}
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="h-14 w-14 rounded-2xl bg-[#fff4ef] text-[#ff6b57] flex items-center justify-center">
                      <Plus size={24} />
                    </div>
                ...
                {addresses.map((item) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`w-full text-left rounded-[32px] border p-6 transition-all ${
                        active
                          ? "border-[#ff7a45] shadow-[0_10px_40px_rgba(255,120,100,0.15)]"
                          : darkMode
                    ...
                    >
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="flex items-start gap-5">
                          <div
                            className={`h-20 w-20 rounded-[26px] flex items-center justify-center ${
                              active
                          ...
                          <div>
                            ...
                            {active && (
                              <div className="mt-5 inline-flex items-center gap-2 bg-green-100 text-green-600 px-4 py-2 rounded-full text-sm font-black">
                        ...
                        {active && (
                          <div className="h-10 w-10 rounded-full border-4 border-green-500 flex items-center justify-center">
          ...
          <div className="block">
            ...
            >
              ...
              <div className="p-5 md:p-6">
                ...
                <h2 className="text-[28px] md:text-3xl font-black mt-5 leading-tight">
                ...
                <p
                  className={`mt-4 leading-7 text-sm md:text-base ${
                    darkMode
                      ? "text-gray-400"
                      : "text-gray-500"
                  }`}
        ...
        <div className="w-full max-w-[620px]">
          <Link to="/checkout/payment">
            <motion.button
              ...
              className="w-full"
            >
              <div className="bg-gradient-to-r from-orange-500 to-pink-500 rounded-[28px] px-5 py-4 shadow-[0_15px_40px_rgba(255,110,90,0.3)]">
